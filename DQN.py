...
class DQNAgent:
    def __init__(self, state_size, action_size, alpha=0.001, gamma=0.94, epsilon=0.95, epsilon_min=0.12, epsilon_decay=0.99, memory_size=10000, batch_size=64, target_update=10):
